...
const (
	SecurityService_CheckPermission_FullMethodName = "/user.SecurityService/CheckPermission"
)
...
type SecurityServiceClient interface {
	CheckPermission(ctx context.Context, in *UserDataRequest, opts ...grpc.CallOption) (*UseDataResponse, error)
}
...
func (c *securityServiceClient) CheckPermission(ctx context.Context, in *UserDataRequest, opts ...grpc.CallOption) (*UseDataResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UseDataResponse)
	err := c.cc.Invoke(ctx, SecurityService_CheckPermission_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SecurityServiceServer interface {
	CheckPermission(context.Context, *UserDataRequest) (*UseDataResponse, error)
...
func (UnimplementedSecurityServiceServer) CheckPermission(context.Context, *UserDataRequest) (*UseDataResponse, error) {
...
func _SecurityService_CheckPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecurityServiceServer).CheckPermission(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecurityService_CheckPermission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecurityServiceServer).CheckPermission(ctx, req.(*UserDataRequest))
	}
...
var SecurityService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.SecurityService",
	HandlerType: (*SecurityServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CheckPermission",
			Handler:    _SecurityService_CheckPermission_Handler,
		},
	},
