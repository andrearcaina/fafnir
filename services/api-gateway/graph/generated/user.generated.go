...
func (ec *executionContext) unmarshalInputProfileDataRequest(ctx context.Context, obj any) (model.ProfileDataRequest, error) {
	var it model.ProfileDataRequest
...
func (ec *executionContext) unmarshalNProfileDataRequest2fafnirᚋapiᚑgatewayᚋgraphᚋmodelᚐProfileDataRequest(ctx context.Context, v any) (model.ProfileDataRequest, error) {
	res, err := ec.unmarshalInputProfileDataRequest(ctx, v)
