...
const (
	SecurityService_CheckPermission_FullMethodName = "/security.SecurityService/CheckPermission"
)
...
func (c *securityServiceClient) CheckPermission(ctx context.Context, in *CheckPermissionRequest, opts ...grpc.CallOption) (*CheckPermissionResponse, error) {
...
func (UnimplementedSecurityServiceServer) CheckPermission(context.Context, *CheckPermissionRequest) (*CheckPermissionResponse, error) {
...
func _SecurityService_CheckPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecurityServiceServer).CheckPermission(ctx, req.(*CheckPermissionRequest))
	}
